...
if (usevpa)||(usesingle)
	filename = sprintf('exp_pap_fig71_%d_%d_%f_%d_vpa.tex',n,p,t0,example);
else		
	filename = sprintf('exp_pap_fig71_%d_%d_%f_%d.tex',n,p,t0,example);
end
